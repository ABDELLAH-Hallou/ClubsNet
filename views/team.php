...
<div class="team-row">
    ...
    <div class="profile notmine">
        ...
        <div class="social">
            ...
            <a href="https://www.linkedin.com/in/abdellah-hallou" target="_blank"><i class="fa fa-linkedin"></i></a>
        </div>
        <p>"La vie non examinée ne vaut pas la peine d'être vécue."</p>
    </div>
    ...
    <div class="profile notmine">
        ...
        <div class="social">
            ...
            <a href="https://www.linkedin.com/in/chaima-izouarhn-010310/" target="_blank"><i class="fa fa-linkedin"></i></a>
        </div>
        <p>"C'est à force de forger qu'on devient forgeron."</p>
    </div>
</div>
